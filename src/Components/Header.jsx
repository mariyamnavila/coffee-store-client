...
const Header = () => {
    return (
        <div className="bg-[url('./assets/header.png')] h-screen bg-cover bg-center py-[225px] flex justify-end text-white">
            <div className="space-y-5 md:w-1/2 w-2/3 max-w-7xl ">
                ...
                <button className="btn rancho bg-[#E3B577] hover:bg-transparent hover:text-white border border-[#E3B577] text-xl">Learn More</button>
            </div>
        </div>
    );
};
